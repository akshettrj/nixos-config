  ...
  options =
    let
      ...
      known_editors = lib.attrNames (
        import ./common/metadata/programs/editors/metadata.nix { inherit pkgs; }
      );
      ...
      known_terminals = lib.attrNames (
        import ./common/metadata/programs/terminals/metadata.nix { inherit pkgs; }
      );
      known_screenlocks = lib.attrNames (
        import ./common/metadata/programs/screenlocks/metadata.nix { inherit pkgs; }
      );
